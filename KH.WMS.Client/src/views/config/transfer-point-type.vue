<template>
    <div style="height: 100%; display: flex; flex-direction: column;">
        <KhPage ref="pageRef" module="transfer-point-type" title="接驳口类型配置" :search-columns="searchColumns"
            ...
            :crud-operations="crudOperations" :permission-prefix="'cfg:transfer_pt_type'"
...
const crudApi = useCrudApi('transfer-point-type')
...
const tableColumns = [
    ...
    { prop: 'allowInbound', label: '是否入库接驳', minWidth: 140, },
    { prop: 'allowOutbound', label: '是否出库接驳', minWidth: 140, },
...
const formColumns = [
    ...
    { prop: 'allowInbound', label: '是否入库接驳', type: 'switch', required: true, labelWidth: 120, activeValue: 1, inactiveValue: 0 },
    { prop: 'allowOutbound', label: '是否出库接驳', type: 'switch', required: true, labelWidth: 120, activeValue: 1, inactiveValue: 0 },
    {
        prop: 'color', label: '颜色标识', type: 'select', required: true, options: [
...
const extraActionButtons = [
  {
    ...
    type: 'warning',
    permission: 'cfg:transfer_pt_type:toggle',
