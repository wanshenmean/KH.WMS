<template>
  <div style="height: 100%; display: flex; flex-direction: column;">
    <KhPage
      ...
      :permission-prefix="'cfg:doc_field'"
...
const crudApi = useCrudApi('document-field')

// ==================== 搜索 ====================
const searchColumns = [
  { prop: 'docTypeId', label: '单据类型', type: 'select', clearable: true, options: 'dict:doc_type_list' },
...
const searchModel = reactive({ docTypeId: '', fieldKey: '', fieldLevel: '' })

// ==================== 表格列 ====================
const tableColumns = [
  { prop: 'docTypeId', label: '单据类型', width: 150, type: 'tag', tagMap: 'dict:doc_type_list' },
...
const formColumns = [
  {
    ...
    options: 'dict:doc_type_list', placeholder: '请选择单据类型',
  },
  { prop: 'fieldKey', label: '字段标识', type: 'input', required: true, maxlength: 50, placeholder: '如 businessType、projectCode' },
  { prop: 'fieldName', label: '显示名称', type: 'input', required: true, maxlength: 100, placeholder: '如 业务类型、项目编号' },
