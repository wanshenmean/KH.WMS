<template>
    <div style="height: 100%; display: flex; flex-direction: column;">
        <KhPage ref="pageRef" module="warehouse-zone-type" title="库区类型配置" :search-columns="searchColumns"
            ...
            :crud-operations="crudOperations" :permission-prefix="'cfg:zone_type'" :action-buttons="extraActionButtons"
...
const crudApi = useCrudApi('warehouse-zone-type')
...
const extraActionButtons = [
  {
    ...
    type: 'warning',
    permission: 'cfg:zone_type:toggle',
