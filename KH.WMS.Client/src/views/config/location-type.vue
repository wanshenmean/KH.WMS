<template>
    <div style="height: 100%; display: flex; flex-direction: column;">
        <KhPage ref="pageRef" module="location-type" title="库位类型配置" :search-columns="searchColumns"
            ...
            :crud-operations="crudOperations" :permission-prefix="'cfg:location_type'"
...
const crudApi = useCrudApi('location-type')
...
const tableColumns = [
    ...
    { prop: 'sortNo', label: '排序号', minWidth: 90, },
...
const extraActionButtons = [
  {
    ...
    type: 'warning',
    permission: 'cfg:location_type:toggle',
